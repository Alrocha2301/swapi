...
class PlanetControllerTest {
    ...
    @Test
    public void createPlanet_WithValidateData_ReturnsCreate() throws Exception {
    ...
    @Test
    public void getById_ByExistingId_ReturnsPlanet() throws Exception{
    ...
    @Test
    public void getById_ByUnexistingId_ReturnsNotFound() throws Exception {
    ...
    @Test
    public void getByName_ByExistingName_ReturnsPlanet() throws Exception {
        when(planetService.getByName("nome")).thenReturn(Optional.of(PLANET));
    ...
    @Test
    public void getByName_ByUnexistingName_ReturnsNotFound() throws Exception {
        mockMvc.perform(get("/planets/name/nome"))
                .andExpect(status().isNotFound());
    }
    ...
    public void listPlanets_ReturnFilteredPlanets() throws Exception{
        ...
        mockMvc.perform(get("/planets?" + String.format("terrain=%s&climate=%s",
